            ...
            for event_ind in range(num_events):
                ...
                # track section ----------------------------------------------------------------
                    ...
                    for track_index in range(num_tracks):
                        ...
                        track_z0 = np.array([event_data["trackZ0"][event_ind][track_index]])
                        track_eta = np.array([event_data["trackEta"][event_ind][track_index]])
                        track_phi = np.array([event_data["trackPhi"][event_ind][track_index]])
                    ...
                    globals_list = [global_node,
                                    track_pt.astype(np.float32),
                                    track_eta.astype(np.float32), track_phi.astype(np.float32), track_z0.astype(np.float32)]
...
#                              'globals': global_node.astype(np.float32),
            ...
            ### Pi0
#             if self.pi0_file_list is not None:
