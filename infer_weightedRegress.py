...
if __name__=="__main__":
    ...
    parser.add_argument('--save_dir', default='/hpcfs/users/a1768536/AGPF/gnn4pions/run/results/onetrack_multicluster/test_20240304')
    args = parser.parse_args()

    with open(args.save_dir + '/config.yaml', 'r') as file:
        ...
        output_dir = '/hpcfs/users/a1768536/AGPF/gnn4pions/run/results/'
        ...
        pi0_files = np.sort(glob.glob(data_dir+'pi0/*ser*/*root'))
        pion_files = np.sort(glob.glob(data_dir+'n0/*ser*/*root'))
        train_start = 0
