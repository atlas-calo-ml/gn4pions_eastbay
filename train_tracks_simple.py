...
if __name__=="__main__":
    ...
    parser.add_argument('--config', default='gn4pions/configs/track_simple.yaml')
    ...
    if start_epoch:
        ...
        save_dir = train_config['save_dir'] + '/Simple_'+time.strftime("%Y%m%d_%H%M")+'_'+args.config.replace('.yaml','').split('/')[-1]
